...
export default function AssistantLanding({ onStart }: AssistantLandingProps) {
  ...
  return (
    <div className="sai-root">
      ...
      <div className="sai-blobs" aria-hidden="true">
        <div className="sai-blob sai-blob-1" />
        <div className="sai-blob sai-blob-2" />
        <div className="sai-blob sai-blob-3" />
      </div>
      ...
      <div className="sai-content">
        ...
        <section className={`sai-hero ${vis}`}>
          ...
          <div className="sai-icon-wrap">
            <span className="sai-ring-1" />
            <span className="sai-ring-2" />
            <div className="sai-icon-inner">
          ...
          {/* CTA */}
          <button onClick={onStart} className="sai-cta-primary">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
            </svg>
            Start a Conversation
            <svg className="sai-cta-arr" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
